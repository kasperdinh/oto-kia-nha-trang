      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="relative h-80 rounded-2xl overflow-hidden shadow-xl">
            <Image
              src="https://images.unsplash.com/photo-1562141993-9c595371b2K2?auto=format&fit=crop&q=80&w=1000"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex gap-4 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
              <div className="shrink-0 w-24 h-24 bg-gray-200 rounded-lg relative overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1632823471445-0d0505a74e5f?auto=format&fit=crop&q=80&w=300"
                  alt="Sales"
                  fill
                  className="object-cover"
                />
            ...
            <div className="flex gap-4 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
              <div className="shrink-0 w-24 h-24 bg-gray-200 rounded-lg relative overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1540828771343-6c7c00676a6d?auto=format&fit=crop&q=80&w=300"
                  alt="Service"
                  fill
                  className="object-cover"
                />
            ...
            <div className="flex gap-4 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
              <div className="shrink-0 w-24 h-24 bg-gray-200 rounded-lg relative overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1598472449045-813c9e9926f7?auto=format&fit=crop&q=80&w=300"
                  alt="Parts"
                  fill
                  className="object-cover"
                />
