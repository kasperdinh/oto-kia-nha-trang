...
function getCarBySlug(slug: string) {
  ...
  const vehicles: Record<string, CarData> = {
    "kia-seltos": {
      ...
      images: [
        "https://images.unsplash.com/photo-1626880556276-888e228519d5?auto=format&fit=crop&q=80&w=1200",
        "https://images.unsplash.com/photo-1626880556550-482865912386?auto=format&fit=crop&q=80&w=1200",
        "https://images.unsplash.com/photo-1626880556485-649033285786?auto=format&fit=crop&q=80&w=1200",
      ],
      specs: {
        engine: "1.4L Turbo",
        power: "138 HP",
    ...
    "kia-sonet": {
      ...
      images: [
        "https://images.unsplash.com/photo-1658428172911-39659f71c991?auto=format&fit=crop&q=80&w=1200",
        "https://images.unsplash.com/photo-1658428172421-2a4b0805c21f?auto=format&fit=crop&q=80&w=1200",
      ],
      specs: {
    ...
    "kia-carnival": {
      ...
      images: [
        "https://images.unsplash.com/photo-1626241957262-4217351658cb?auto=format&fit=crop&q=80&w=1200",
        "https://images.unsplash.com/photo-1626241956892-026850cb123f?auto=format&fit=crop&q=80&w=1200",
      ],
      specs: {
